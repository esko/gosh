    ...
    const modal = elFromHTML(`
      <div class="modal">
        ...
        <form id="connForm">
          ...
          <label class="field"><span>address</span><input name="host" value="${escapeHTML(existing?.host ?? '')}" placeholder="192.0.2.10" autocomplete="off" spellcheck="false" required></label>
          <div class="field-row">
