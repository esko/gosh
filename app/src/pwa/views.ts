  ...
  root.innerHTML = `
    <div class="connect-page">
      <form id="terminalConnect">
        ...
        <label class="field"><span>address</span><input id="terminalCommand" name="host" placeholder="user@host.example" autocomplete="off" spellcheck="false" autofocus></label>
